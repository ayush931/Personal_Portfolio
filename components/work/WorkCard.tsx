...
export function WorkCard({ project, index }: { project: Project; index: number }) {
  return (
    <div
      data-work-card
      className="group relative rounded-panel border border-line bg-canvas-raised p-8 md:p-12 transition-all duration-300 hover:border-cobalt hover:-translate-y-1 hover:shadow-md shadow-sm"
    >
