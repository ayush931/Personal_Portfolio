...
export function WorkCard({ project, index }: { project: Project; index: number }) {
  ...
  return (
    <div
      ...
      data-work-card
      className="group relative rounded-panel border border-line bg-canvas-raised p-8 md:p-12 transition-transform duration-300 ease-out hover:border-cobalt shadow-sm"
      style={{
        background: `radial-gradient(500px circle at var(--mouse-x, 50%) var(--mouse-y, 50%), rgba(37, 99, 235, 0.06), transparent 80%), var(--canvas-raised)`,
      }}
    >
