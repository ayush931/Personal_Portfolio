  ...
  const experiences: ExperienceItem[] = [
    {
      ...
      description: [
        "Built a custom Word add-in in TypeScript (Office.js) to automate style enforcement, cutting manual formatting effort by 60% for a 15-person editorial team.",
        "Architected a 4-microservice document conversion platform using FastAPI and React, reducing processing turnaround by 45%.",
        "Automated Table of Contents generation for XML/EPUB publishing pipelines (JATS, DocBook schemas), cutting QA review time by 35%.",
      ],
    ...
    },
    {
      ...
      description: [
        "Built a real-time logistics platform (PERN) with shipment tracking, delivery workflows, and RBAC, boosting database query performance by 25%.",
